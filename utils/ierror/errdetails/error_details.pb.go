...
// a request could respond with a QuotaFailure detail containing the project
// id and the description of the quota limit that was exceeded.  If the
// calling project hasn't enabled the request in the developer console, then
// a request could respond with the project id and set `service_disabled`
// to true.
//
...
type ErrorInfo struct {
	...
	// is typically the registered request name of the tool or product_service that
...
// acknowledged, it could list the terms of request violation in the
...
type RequestInfo struct {
	...
	// An opaque string that should only be interpreted by the request generating
	// it. For example, it can be used to identify requests in the request's logs.
	RequestId string `protobuf:"bytes,1,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`
	// Any data that was used to serve this validation. For example, an encrypted
	// stack trace that can be sent back to the request provider for debugging.
...
// project hasn't enabled the accessed request, this can contain a URL pointing
...
type QuotaFailure_Violation struct {
	...
	// description to find more about the quota configuration in the request's
...
type PreconditionFailure_Violation struct {
	...
	// The type of PreconditionFailure. We recommend using a request-specific
	// enum type to define the supported precondition violation subjects. For
	// example, "TOS" for "Terms of Service violation".
	Type string `protobuf:"bytes,1,opt,name=type,proto3" json:"type,omitempty"`
	// The subject, relative to the type, that failed.
	// For example, "google.com/cloud" relative to the "TOS" type would indicate
	// which terms of request is being referenced.
	Subject string `protobuf:"bytes,2,opt,name=subject,proto3" json:"subject,omitempty"`
	// A description of how the precondition failed. Developers can use this
	// description to understand how to fix the failure.
	//
	// For example: "Terms of request not accepted".
