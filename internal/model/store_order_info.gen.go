...
type StoreOrderInfo struct {
	...
	OrderID      int64                 `gorm:"column:order_id;type:int(10) unsigned;not null;comment:订单id" json:"order_id"`                          // 订单id
	...
	AttrValueID  int64                 `gorm:"column:attr_value_id;type:int(10) unsigned;comment:规格属性值id" json:"attr_value_id"`                      // 规格属性值id
	...
	PayNum       int64                 `gorm:"column:pay_num;type:int(10) unsigned;not null;comment:购买数量" json:"pay_num"`                            // 购买数量
	...
	GiveIntegral int64                 `gorm:"column:give_integral;type:int(10) unsigned;not null;comment:赠送积分" json:"give_integral"`                // 赠送积分
	...
	ProductType  int64                 `gorm:"column:product_type;type:int(11);not null;comment:商品类型:0-普通，1-秒杀，2-砍价，3-拼团，4-视频号" json:"product_type"` // 商品类型:0-普通，1-秒杀，2-砍价，3-拼团，4-视频号
