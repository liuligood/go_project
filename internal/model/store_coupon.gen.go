...
type StoreCoupon struct {
	...
	Money            string                `gorm:"column:money;type:decimal(8,2) unsigned;not null;default:0.00;comment:兑换的优惠券面值" json:"money"`            // 兑换的优惠券面值
	...
	MinPrice         string                `gorm:"column:min_price;type:decimal(8,2) unsigned;not null;default:0.00;comment:最低消费，0代表不限制" json:"min_price"` // 最低消费，0代表不限制
