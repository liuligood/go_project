...
type UserLevel struct {
	...
	LevelID     int64                 `gorm:"column:level_id;type:int(11);not null;comment:等级vip" json:"level_id"`            // 等级vip
	...
	ExpiredTime int64                 `gorm:"column:expired_time;type:bigint(20)" json:"expired_time"`
