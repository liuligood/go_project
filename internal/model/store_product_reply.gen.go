...
type StoreProductReply struct {
	ID                   int64                 `gorm:"column:id;type:int(11);primaryKey;autoIncrement:true;comment:评论ID" json:"id"`                             // 评论ID
	...
	ProductScore         int64                 `gorm:"column:product_score;type:tinyint(3) unsigned;not null;comment:商品分数" json:"product_score"`                // 商品分数
	ServiceScore         int64                 `gorm:"column:service_score;type:tinyint(3) unsigned;not null;comment:服务分数" json:"service_score"`                // 服务分数
	...
	MerchantReplyTime    int64                 `gorm:"column:merchant_reply_time;type:int(10) unsigned;not null;comment:管理员回复时间" json:"merchant_reply_time"`    // 管理员回复时间
	IsReply              int64                 `gorm:"column:is_reply;type:tinyint(3) unsigned;not null;comment:0未回复1已回复" json:"is_reply"`                      // 0未回复1已回复
