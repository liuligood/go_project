...
type StoreProductReply struct {
	...
	ProductScore         int64                 `gorm:"column:product_score;type:tinyint(1);not null;comment:商品分数" json:"product_score"`                         // 商品分数
	ServiceScore         int64                 `gorm:"column:service_score;type:tinyint(1);not null;comment:服务分数" json:"service_score"`                         // 服务分数
