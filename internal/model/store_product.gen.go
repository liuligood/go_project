...
type StoreProduct struct {
	...
	Sort         int64                 `gorm:"column:sort;type:smallint unsigned;not null;comment:排序" json:"sort"`                              // 排序
	...
	IsShow       int64                 `gorm:"column:is_show;type:tinyint unsigned;not null;default:1;comment:状态（0：未上架，1：上架）" json:"is_show"`   // 状态（0：未上架，1：上架）
	IsHot        int64                 `gorm:"column:is_hot;type:tinyint(1);not null;comment:是否热卖" json:"is_hot"`                               // 是否热卖
	IsBenefit    int64                 `gorm:"column:is_benefit;type:tinyint unsigned;not null;comment:是否优惠" json:"is_benefit"`                 // 是否优惠
	IsBest       int64                 `gorm:"column:is_best;type:tinyint unsigned;not null;comment:是否精品" json:"is_best"`                       // 是否精品
	IsNew        int64                 `gorm:"column:is_new;type:tinyint unsigned;not null;comment:是否新品" json:"is_new"`                         // 是否新品
	...
	GiveIntegral int64                 `gorm:"column:give_integral;type:int unsigned;not null;comment:获得积分" json:"give_integral"`               // 获得积分
	...
	IsBargain    int64                 `gorm:"column:is_bargain;type:tinyint unsigned;not null;comment:砍价状态 0未开启 1开启" json:"is_bargain"`        // 砍价状态 0未开启 1开启
	IsGood       int64                 `gorm:"column:is_good;type:tinyint unsigned;not null;comment:是否优品推荐" json:"is_good"`                     // 是否优品推荐
	IsSub        int64                 `gorm:"column:is_sub;type:tinyint unsigned;not null;comment:是否单独分佣" json:"is_sub"`                       // 是否单独分佣
	Ficti        int64                 `gorm:"column:ficti;type:mediumint unsigned;not null;default:100;comment:虚拟销量" json:"ficti"`             // 虚拟销量
	Browse       int64                 `gorm:"column:browse;type:int unsigned;not null;comment:浏览量" json:"browse"`                              // 浏览量
	...
	TempID       int64                 `gorm:"column:temp_id;type:int unsigned;not null;default:1;comment:运费模板ID" json:"temp_id"`               // 运费模板ID
	SpecType     int64                 `gorm:"column:spec_type;type:tinyint unsigned;not null;comment:规格 0单 1多" json:"spec_type"`               // 规格 0单 1多
	...
	IsRecycle    int64                 `gorm:"column:is_recycle;type:tinyint unsigned;not null;comment:是否回收站" json:"is_recycle"`                // 是否回收站
