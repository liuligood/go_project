...
type StoreProductAttrValue struct {
	...
	Quota        int64                 `gorm:"column:quota;type:int unsigned;not null;comment:活动限购数量" json:"quota"`                                     // 活动限购数量
	QuotaShow    int64                 `gorm:"column:quota_show;type:int unsigned;not null;comment:活动限购数量显示" json:"quota_show"`                         // 活动限购数量显示
