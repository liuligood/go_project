...
type UserBrokerageRecord struct {
	...
	Type           int64                 `gorm:"column:type;type:int(11);not null;default:1;comment:类型：1-增加，2-扣减（提现）" json:"type"`                              // 类型：1-增加，2-扣减（提现）
	...
	FrozenTime     int64                 `gorm:"column:frozen_time;type:int(11);not null;comment:冻结期时间（天）" json:"frozen_time"`                                  // 冻结期时间（天）
	ThawTime       int64                 `gorm:"column:thaw_time;type:bigint(20);not null;comment:解冻时间" json:"thaw_time"`                                       // 解冻时间
	BrokerageLevel int64                 `gorm:"column:brokerage_level;type:int(11);comment:分销等级" json:"brokerage_level"`                                       // 分销等级
