...
const TableNameUserBill = "user_bill"
...
type UserBill struct {
	...
	Pm        int64                 `gorm:"column:pm;type:tinyint unsigned;not null;comment:0 = 支出 1 = 获得" json:"pm"`                      // 0 = 支出 1 = 获得
	...
	Number    string                `gorm:"column:number;type:decimal(8,2) unsigned;not null;default:0.00;comment:明细数字" json:"number"`     // 明细数字
	Balance   string                `gorm:"column:balance;type:decimal(16,2) unsigned;not null;default:0.00;comment:剩余" json:"balance"`    // 剩余
