...
type UserBill struct {
	ID        int64                 `gorm:"column:id;type:int(10) unsigned;primaryKey;autoIncrement:true;comment:用户账单id" json:"id"`        // 用户账单id
	...
	Pm        int64                 `gorm:"column:pm;type:tinyint(3) unsigned;not null;comment:0 = 支出 1 = 获得" json:"pm"`                   // 0 = 支出 1 = 获得
