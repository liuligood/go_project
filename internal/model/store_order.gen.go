...
type StoreOrder struct {
	...
	PayTime                int64                 `gorm:"column:pay_time;type:bigint unsigned;not null;comment:支付时间" json:"pay_time"`                                  // 支付时间
	PayType                string                `gorm:"column:pay_type;type:varchar(32);not null;comment:支付方式" json:"pay_type"`                                      // 支付方式
	Status                 int64                 `gorm:"column:status;type:tinyint unsigned;not null;comment:订单状态（0：待发货；1：待收货；2：已收货，待评价；3：已完成；）" json:"status"`       // 订单状态（0：待发货；1：待收货；2：已收货，待评价；3：已完成；）
	...
	RefundReasonTime       int64                 `gorm:"column:refund_reason_time;type:bigint unsigned;not null;comment:退款时间" json:"refund_reason_time"`              // 退款时间
	...
	GainIntegral           int64                 `gorm:"column:gain_integral;type:int unsigned;not null;comment:消费赚取积分" json:"gain_integral"`                         // 消费赚取积分
	UseIntegral            int64                 `gorm:"column:use_integral;type:int unsigned;not null;comment:使用积分" json:"use_integral"`                             // 使用积分
	BackIntegral           int64                 `gorm:"column:back_integral;type:int unsigned;not null;comment:给用户退了多少积分" json:"back_integral"`                      // 给用户退了多少积分
	...
	CombinationID          int64                 `gorm:"column:combination_id;type:int unsigned;not null;comment:拼团商品id0一般商品" json:"combination_id"`                       // 拼团商品id0一般商品
	...
	StoreID                int64                 `gorm:"column:store_id;type:int unsigned;not null;comment:门店id" json:"store_id"`                                          // 门店id
	ShippingType           int64                 `gorm:"column:shipping_type;type:tinyint unsigned;not null;default:1;comment:配送方式 1=快递 ，2=门店自提" json:"shipping_type"`     // 配送方式 1=快递 ，2=门店自提
	ClerkID                int64                 `gorm:"column:clerk_id;type:int unsigned;not null;comment:店员id/核销员id" json:"clerk_id"`                                    // 店员id/核销员id
	IsChannel              int64                 `gorm:"column:is_channel;type:tinyint unsigned;not null;comment:支付渠道(0微信公众号1微信小程序2余额)" json:"is_channel"`                 // 支付渠道(0微信公众号1微信小程序2余额)
	IsRemind               int64                 `gorm:"column:is_remind;type:tinyint unsigned;not null;comment:消息提醒" json:"is_remind"`                                    // 消息提醒
	IsSystemDel            int64                 `gorm:"column:is_system_del;type:tinyint unsigned;not null;comment:后台是否删除" json:"is_system_del"`                          // 后台是否删除
	...
	Type                   int64                 `gorm:"column:type;type:int unsigned;not null;comment:订单类型:0-普通订单，1-视频号订单" json:"type"`                                   // 订单类型:0-普通订单，1-视频号订单
	...
	IsAlterPrice           int64                 `gorm:"column:is_alter_price;type:tinyint unsigned;not null;comment:是否改价,0-否，1-是" json:"is_alter_price"`                  // 是否改价,0-否，1-是
