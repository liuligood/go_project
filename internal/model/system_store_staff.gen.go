...
type SystemStoreStaff struct {
	...
	VerifyStatus int64                 `gorm:"column:verify_status;type:tinyint;not null;comment:核销开关" json:"verify_status"` // 核销开关
	Status       int64                 `gorm:"column:status;type:tinyint;default:1;comment:状态" json:"status"`                // 状态
