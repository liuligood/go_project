...
type UserRecharge struct {
	...
	Price        string                `gorm:"column:price;type:decimal(8,2);comment:充值金额" json:"price"`                                   // 充值金额
	GivePrice    string                `gorm:"column:give_price;type:decimal(8,2);not null;default:0.00;comment:购买赠送金额" json:"give_price"` // 购买赠送金额
	...
	RefundPrice  string                `gorm:"column:refund_price;type:decimal(10,2);default:0.00;comment:退款金额" json:"refund_price"` // 退款金额
