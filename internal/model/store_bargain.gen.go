...
const TableNameStoreBargain = "store_bargain"

// StoreBargain 砍价表
type StoreBargain struct {
	ID              int64                 `gorm:"column:id;type:int(10) unsigned;primaryKey;autoIncrement:true;comment:砍价商品ID" json:"id"`                             // 砍价商品ID
	ProductID       int64                 `gorm:"column:product_id;type:int(10) unsigned;not null;comment:关联商品ID" json:"product_id"`                                  // 关联商品ID
	...
	Stock           int64                 `gorm:"column:stock;type:int(10) unsigned;comment:库存" json:"stock"`                                                         // 库存
	Sales           int64                 `gorm:"column:sales;type:int(10) unsigned;comment:销量" json:"sales"`                                                         // 销量
	Images          string                `gorm:"column:images;type:varchar(2000);not null;comment:砍价商品轮播图" json:"images"`                                            // 砍价商品轮播图
	StartTime       int64                 `gorm:"column:start_time;type:bigint(20) unsigned;not null;comment:砍价开启时间" json:"start_time"`                               // 砍价开启时间
	StopTime        int64                 `gorm:"column:stop_time;type:bigint(20) unsigned;not null;comment:砍价结束时间" json:"stop_time"`                                 // 砍价结束时间
	...
	Num             int64                 `gorm:"column:num;type:int(10) unsigned;comment:购买数量限制——单个活动每个用户发起砍价次数限制" json:"num"`                                       // 购买数量限制——单个活动每个用户发起砍价次数限制
	...
	BargainNum      int64                 `gorm:"column:bargain_num;type:int(10) unsigned;not null;default:1;comment:帮砍次数——单个商品用户可以帮砍的次数" json:"bargain_num"`         // 帮砍次数——单个商品用户可以帮砍的次数
	Status          int64                 `gorm:"column:status;type:tinyint(3) unsigned;not null;default:1;comment:砍价状态 0(到砍价时间不自动开启)  1(到砍价时间自动开启时间)" json:"status"` // 砍价状态 0(到砍价时间不自动开启)  1(到砍价时间自动开启时间)
	GiveIntegral    int64                 `gorm:"column:give_integral;type:int(11);comment:反多少积分" json:"give_integral"`                                               // 反多少积分
	...
	IsHot           int64                 `gorm:"column:is_hot;type:tinyint(3) unsigned;not null;comment:是否推荐0不推荐1推荐" json:"is_hot"`                                  // 是否推荐0不推荐1推荐
	AddTime         int64                 `gorm:"column:add_time;type:bigint(20) unsigned;comment:添加时间" json:"add_time"`                                              // 添加时间
	IsPostage       int64                 `gorm:"column:is_postage;type:tinyint(3) unsigned;not null;default:1;comment:是否包邮 0不包邮 1包邮" json:"is_postage"`              // 是否包邮 0不包邮 1包邮
	...
	Look            int64                 `gorm:"column:look;type:int(10) unsigned;comment:砍价商品浏览量" json:"look"`                                                      // 砍价商品浏览量
	Share           int64                 `gorm:"column:share;type:int(10) unsigned;comment:砍价商品分享量" json:"share"`                                                    // 砍价商品分享量
	TempID          int64                 `gorm:"column:temp_id;type:int(11);comment:运费模板ID" json:"temp_id"`                                                          // 运费模板ID
	...
	PeopleNum       int64                 `gorm:"column:people_num;type:int(11);comment:砍价人数——需要多少人砍价成功" json:"people_num"`                                           // 砍价人数——需要多少人砍价成功
