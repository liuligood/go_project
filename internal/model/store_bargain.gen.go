...
type StoreBargain struct {
	...
	Price           string                `gorm:"column:price;type:decimal(8,2) unsigned;comment:砍价金额" json:"price"`                                               // 砍价金额
	MinPrice        string                `gorm:"column:min_price;type:decimal(8,2) unsigned;comment:砍价商品最低价" json:"min_price"`                                    // 砍价商品最低价
	Num             int64                 `gorm:"column:num;type:int unsigned;comment:购买数量限制——单个活动每个用户发起砍价次数限制" json:"num"`                                        // 购买数量限制——单个活动每个用户发起砍价次数限制
	BargainMaxPrice string                `gorm:"column:bargain_max_price;type:decimal(8,2) unsigned;comment:用户每次砍价的最大金额" json:"bargain_max_price"`                // 用户每次砍价的最大金额
	BargainMinPrice string                `gorm:"column:bargain_min_price;type:decimal(8,2) unsigned;comment:用户每次砍价的最小金额" json:"bargain_min_price"`                // 用户每次砍价的最小金额
	...
	Cost            string                `gorm:"column:cost;type:decimal(8,2) unsigned;comment:成本价" json:"cost"`                                                  // 成本价
	...
	Postage         string                `gorm:"column:postage;type:decimal(10,2) unsigned;comment:邮费" json:"postage"`                                            // 邮费
	...
	Weight          string                `gorm:"column:weight;type:decimal(8,2);default:0.00;comment:重量" json:"weight"`                                           // 重量
	Volume          string                `gorm:"column:volume;type:decimal(8,2);default:0.00;comment:体积" json:"volume"`                                           // 体积
