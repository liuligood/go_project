...
type StoreBargainUser struct {
	...
	BargainPriceMin string                `gorm:"column:bargain_price_min;type:decimal(8,2) unsigned;comment:砍价的最低价" json:"bargain_price_min"`     // 砍价的最低价
	BargainPrice    string                `gorm:"column:bargain_price;type:decimal(8,2);comment:砍价金额" json:"bargain_price"`                        // 砍价金额
	Price           string                `gorm:"column:price;type:decimal(8,2) unsigned;comment:砍掉的价格" json:"price"`                              // 砍掉的价格
	...
	IsDel           int64                 `gorm:"column:is_del;type:tinyint(1);not null;comment:是否取消" json:"is_del"`                               // 是否取消
