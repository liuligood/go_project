...
import (
	...
	"crmeb_go/internal/router/api/product"
	"crmeb_go/internal/router/api/public"
...
func ApiRegister(app *gin.RouterGroup, appCxt *internal.AppContent) {
	...
	// 授权路由
	public.Register(app.Group("/public"), appCxt)

	// 授权路由
	product.Register(app.Group("/product"), appCxt)
}
